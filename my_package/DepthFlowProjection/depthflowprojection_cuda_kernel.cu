...
//    printf("I am here\n");
	...
	AT_DISPATCH_FLOATING_TYPES(input1.scalar_type(), "DepthFlowProjection_gpu_forward", ([&] {
...
//    printf("I am there\n");
	...
	AT_DISPATCH_FLOATING_TYPES(input1.scalar_type(), "DepthFlowProjectionAveraging", ([&] {
...
//        printf("use flow fill hole\n");
	AT_DISPATCH_FLOATING_TYPES(input1.scalar_type(), "DepthFlowFillhole", ([&] {
